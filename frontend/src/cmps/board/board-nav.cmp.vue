<template>
	<section class="board-nav">
		...
		<div class="nav-members">
			...
			<h5 @click.stop="toggleUserList"><i class="el-icon-plus"></i><i class="el-icon-user"></i></h5>
		</div>
		<div class="btns-container">
			<div @click.stop class="search-container">
				<app-filter v-if="isFilterInputShown" @openFilterModal="openFilterModal" @filterSet="filterSet"></app-filter>
				<button @click.stop="showFilterInput">
